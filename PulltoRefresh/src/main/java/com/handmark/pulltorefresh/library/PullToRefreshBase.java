...
Log.d(LOG_TAG, "___doScroll = " + doScroll +", mShowViewWhileRefreshing = " + mShowViewWhileRefreshing);
		if (doScroll) {
			if (mShowViewWhileRefreshing) {
                ...
                if(DEBUG){
                    Log.d(LOG_TAG,"SHIHAIJUN Current mode = " + mCurrentMode);
                }
				switch (mCurrentMode) {
	...
	protected final void refreshLoadingViewsSize() {
		...
		if (DEBUG) {
			Log.d(LOG_TAG, String.format("Setting Padding. L: %d, T: %d, R: %d, B: %d, headerSize: %d", pLeft, pTop, pRight, pBottom,mHeaderLayout.getHeight()));
		}
...
Log.d(LOG_TAG, "oldScrollValue = "+oldScrollValue +", newScrollValue = " + newScrollValue);
